BEGIN
	...
	BEGIN
		...
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Offline Department Members'''' Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Department Assignee''),1,''Blank'','+@siteIdStr+',7),
