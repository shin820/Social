BEGIN
	...
	BEGIN
		...
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Department''''s Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Status''),2,''4'','+@siteIdStr+',3),
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Department''''s Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Department Assignee''),1,''@My Department'','+@siteIdStr+',4),
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Offline Colleagues'''' Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Status''),2,''4'','+@siteIdStr+',5),
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Offline Colleagues'''' Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Agent Assignee''),1,''@My Department Member'','+@siteIdStr+',6),
		((SELECT [Id] FROM [t_Social_Filter] WHERE [SiteId] = '+@siteIdStr+' AND [Name] = ''My Offline Colleagues'''' Open'' AND [IfPublic] = 1),(SELECT [Id] FROM [t_Social_ConversationField] WHERE [SiteId] = '+@siteIdStr+' AND Name=''Department Assignee''),1,''Blank'','+@siteIdStr+',7),
